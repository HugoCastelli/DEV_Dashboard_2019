...
@Component({
  selector: 'app-trello-member-tasks',
  templateUrl: './TrelloMemberTasks.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class TrelloMemberTasksComponent implements OnInit, OnDestroy {
  @Input() widget;
  ...
  async ngOnInit() {
    ...
    const requestWeather = this.baseUrl + 'trello_member_tasks?widget_id=' + this.widget.id;
    const httpOptions = {
