...
@Component({
  selector: 'app-yammer-group-messages',
  templateUrl: './YammerGroupMessages.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class YammerGroupMessagesComponent implements OnInit, OnDestroy {
  @Input() widget;
  ...
  async ngOnInit() {
    ...
    const requestWeather = this.baseUrl + 'group_messages?widget_id=' + this.widget.id;
    const httpOptions = {
