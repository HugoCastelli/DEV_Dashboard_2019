...
@Component({
  selector: 'app-crypto-worth',
  templateUrl: './CryptoWorth.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class CryptoWorthComponent implements OnInit, OnDestroy {
  @Input() widget;
  ...
  async ngOnInit() {
    ...
    const requestWeather = this.baseUrl + 'crypto_actual_worth?widget_id=' + this.widget.id;
    const httpOptions = {
