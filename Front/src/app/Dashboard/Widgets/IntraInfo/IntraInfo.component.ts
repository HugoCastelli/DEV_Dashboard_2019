...
@Component({
  selector: 'app-intra-info',
  templateUrl: './IntraInfo.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class IntraInfoComponent implements OnInit, OnDestroy {
  @Input() widget;
  ...
  async ngOnInit() {
    ...
    const requestWeather = this.baseUrl + 'intra_infos?widget_id=' + this.widget.id;
    const httpOptions = {
