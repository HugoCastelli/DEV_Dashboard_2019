...
@Component({
  selector: 'app-intra-modules',
  templateUrl: './IntraModules.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class IntraModulesComponent implements OnInit, OnDestroy {
  @Input() widget;
  ...
  async ngOnInit() {
    ...
    const requestWeather = this.baseUrl + 'intra_modules?widget_id=' + this.widget.id;
    const httpOptions = {
