...
@Component({
  selector: 'app-trello-list-table',
  templateUrl: './TrelloListTable.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class TrelloListTableComponent implements OnInit, OnDestroy {
  @Input() widget;
  ...
  async ngOnInit() {
    ...
    const requestWeather = this.baseUrl + 'trello_board?widget_id=' + this.widget.id;
    const httpOptions = {
